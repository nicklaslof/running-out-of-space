...
class CollisionEntity extends Entity{
    ...
    tick(game, deltaTime){
        ...
        var newTilePosX = Math.max(0,Math.floor(this.position.x/32));
        var newTilePosY = Math.floor((this.position.y+8)/32);
    ...
    doesCollide(otherEntity){
        ...
        //if (this.type == "po")console.log("size "+ this.collisionSizeX);
